(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Beauty-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "rachaelholy@gmail.com"; // Your Business PayPal's account email address
